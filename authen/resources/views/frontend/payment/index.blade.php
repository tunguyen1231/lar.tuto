...
@section('content')
    ...
    <style type="text/css">
        ...
        #custom-cart .checkout-right-basket a:hover{
            background: #ff9b05;
        }
    </style>
    <div id="custom-cart">
        <div class="checkout">
            <div class="container">
                <h3>Số sản phẩm trong giỏ hàng: <span>{{ $total_qtt_cart }} Sản phẩm</span></h3>
                <!---728x90--->
                ...
                <div class="checkout-right">
                    <table class="timetable_sub">
                        ...
                        <tr class="rem{{ $i }}">
                            ...
                            <td class="invert">{{ number_format($product->price) }}VNĐ</td>
    ...
    <h1>Tổng tiền: <?php echo number_format($total_payment) ?> VNĐ</h1>
                    ...
                    <form name="order_form" action="{{ url('shop/payment') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-50">
                                ...
                                <input type="text" id="fname" name="customer_name" placeholder="Thanh">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-50">
                                        <label for="zip">SĐT</label>
                                        <input type="text" id="customer_phone" name="customer_phone" placeholder="098*******">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-50">
                                ...
                                <input type="text" id="adr" name="customer_address" placeholder="42 Hồ Tùng Mậu">
                                <label for="city"><i class="fa fa-institution"></i> Thành phố</label>
                                <input type="text" id="city" name="customer_city" placeholder="Hà Nội">
                            </div>
